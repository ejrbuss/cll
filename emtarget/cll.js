...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'cll.wast';
  var wasmBinaryFile = 'cll.wasm';
  var asmjsCodeFile = 'cll.temp.asm.js';
...
var real__js_eval = asm["_js_eval"]; asm["_js_eval"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__js_eval.apply(null, arguments);
};

var real__js_init = asm["_js_init"]; asm["_js_init"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__js_init.apply(null, arguments);
};
...
var _js_eval = Module["_js_eval"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_js_eval"].apply(null, arguments) };
var _js_init = Module["_js_init"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_js_init"].apply(null, arguments) };
